...
@Table(name = "saved_opportunities") // sets database table mapping details for this entity
 ...
 */
public class SavedCareer extends BaseEntity { // defines a class type
// @Column configures how this field is stored in the database.
    ...
    private UUID careerId; // executes this statement as part of the application logic
