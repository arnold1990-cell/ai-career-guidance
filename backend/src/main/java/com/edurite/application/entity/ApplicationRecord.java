package com.edurite.application.entity; // declares the package path for this Java file
...
@Table(name = "applications") // sets database table mapping details for this entity
 ...
 */
public class ApplicationRecord extends BaseEntity { // defines a class type
