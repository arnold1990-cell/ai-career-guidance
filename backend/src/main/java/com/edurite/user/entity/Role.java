...
@Table(name = "roles") // sets database table mapping details for this entity
 ...
 */
public class Role extends BaseEntity { // defines a class type
...
// @Column configures how this field is stored in the database.
    ...
    private String name; // executes this statement as part of the application logic
