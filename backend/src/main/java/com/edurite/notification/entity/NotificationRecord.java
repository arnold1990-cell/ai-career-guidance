package com.edurite.notification.entity; // declares the package path for this Java file
...
@Table(name = "notifications") // sets database table mapping details for this entity
 ...
 */
public class NotificationRecord extends BaseEntity { // defines a class type
// @Column configures how this field is stored in the database.
    ...
    private String channel; // executes this statement as part of the application logic
    private String eventType; // executes this statement as part of the application logic
    private String title; // executes this statement as part of the application logic
    private String message; // executes this statement as part of the application logic
// @Column configures how this field is stored in the database.
    @Column(name = "is_read") // configures how this field maps to a database column
    private boolean read; // executes this statement as part of the application logic
    private OffsetDateTime sentAt; // executes this statement as part of the application logic
